...
export default function Viewsetter() {
  ...
  return (
    <div className="hidden md:block absolute bottom-5 left-5 flex flex-row gap-3 box-border p-2 shadow-lg rounded-lg z-5 bg-radial from-gray-100/30 from-20% to-gray-100/50 backdrop-blur-sm">
      <div
